...
function draw() {
    ...
    context.fillText("In some levels there are generators which shoot bullets but you can`t kill them.",0,200);
    context.fillText("When you collect 16 points, you win! ",50,225);
