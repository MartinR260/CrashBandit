// Creating variables
var CrashBanditX=560,CrashBanditY=560,FighterX=1000,FighterY=530,bulletX=1000, bulletY=530,jivoti=8, kills=0;
...
function draw() {
    ...
    context.fillText("Hello! Welcome to Crash Bandit Demo! Press any key to jump and drag with the mouse",0,200);
    context.fillText("to move The Bandit to dodge the bullets and destroy The Fighters.",0,225)
