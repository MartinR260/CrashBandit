...
function draw() {
    ...
    context.fillText("Unless you are pretty good, you`ll notice that you lose one health when you die and you",0,200);
    context.fillText(" recieve one when you kill TheFighter (death=-1 life, kill=+1live).",50,225);
